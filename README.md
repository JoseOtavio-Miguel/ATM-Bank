...
Estrutura do Arquivo O código fonte está organizado em diversas funções que são responsáveis por implementar cada uma das funcionalidades do sistema. A seguir, algumas partes principais do código:
...
Autor Desenvolvido por José Otávio Miguel.
